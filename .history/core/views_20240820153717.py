...
class NovaVenda(View):
    ...
    def post(self, request):
        ...
        if form.is_valid():
            ...
            dados.venda = Venda.objects.create(tipo_venda=tipo_venda)  # Cria a venda e associa ao dados
            dados.save()
            return redirect('adicionar_produtos', venda_id=dados.venda.identificador_unico)
