...
def nova_venda(request, tipo_venda):
    tipo_venda = get_object_or_404(TipoVenda, pk=tipo_venda)
        context = {
        'tipo_venda': tipo_venda,
        'form': VendaEntregaForm() if tipo_venda.tipo == 'Entrega' else VendaRetiradaForm() if tipo_venda.tipo == 'Retirada' else VendaLocalForm(),
